...
def legMoveinWorld(leg,stepLength,Tsup): #consider stepLength
    ...
    if leg == 'l':
        ...
        y = [100 + 1 * t for t in timeList]
        z = [-310 + 40/Tsup * t for t in timeList[0:increment/2]]
        z.extend([-270 -40./Tsup*t for t in timeList[increment/2:increment]])
    if leg == 'r':
...
def move2(robotIP,pace,stepLength):
...
if __name__ == "__main__":
    ...
    x = 1.2
    stepLength = 0.06
    pace = int(x/stepLength)
    move2(robotIp,pace,stepLength)
